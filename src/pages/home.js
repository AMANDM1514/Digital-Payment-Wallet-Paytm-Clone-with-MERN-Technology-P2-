        ...
        <div className="bg-light text-center py-5">
            ...
            <Row className="align-items-center">
               <Col md={6}>
                  ...
                  <p className="lead"> Experience seamless transactions with PayEase. Whether you're a small business or an enterprise, our platform 
                    offers the tools you need to manage payments effortlessly. </p>
